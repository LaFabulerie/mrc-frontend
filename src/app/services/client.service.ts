...
export class ClientService {
  ...
  fetchRemoteAccesses() {
    return this.http.get<any>(`${environment.apiHost}/client/remote-accesses/?expand=org,area`).pipe(
      tap(data => {
  ...
  createRemoteAccess(data: any) {
    return this.http.post<any>(`${environment.apiHost}/client/remote-accesses/`, data);
  }

  deleteRemoteAccess(id: number) {
    return this.http.delete<any>(`${environment.apiHost}/client/remote-accesses/${id}/`);
  }

  synchronizeRemoteAccess(id: number) {
    return this.http.get<any>(`${environment.apiHost}/client/remote-accesses/${id}/synchronize/`);
  }
